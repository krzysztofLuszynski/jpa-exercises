package kluszynski.example.jpa.exercises.optimisticlocking;
...
public final class TestDataContants {
    public static final String CLEAN_DATABASE_SQL_PATH = "/kluszynski/example/jpa/exercises/optimisticlocking/clean_database.sql";
    public static final String JACK_WHITE_SQL_PATH = "/kluszynski/example/jpa/exercises/optimisticlocking/jack_white.sql";
    public static final String JOHNY_BRAVO_SQL_PATH = "/kluszynski/example/jpa/exercises/optimisticlocking/johny_bravo.sql";
